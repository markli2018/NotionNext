...
module.exports = {
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'google.com, pub-9546085067047133, DIRECT, f08c47fec0942fa0', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
