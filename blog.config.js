...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '定期分享资源，福利和最新的互联网动态', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xiaoang.site/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '这里提供有价值的教程、工具和资源，助你提升数字生活！', // 网站关键词 英文逗号隔开
